...
def on_add_transaction_click():
    ...
    add_transaction_window.wm_iconbitmap(r"C:\Users\admin\Desktop\finalproject\img\cash.ico")
...
def delete_transaction(username):
    ...
    delete_transaction_window.wm_iconbitmap("finalproject/img/cash.ico")
...
def modify_transaction(username):
    ...
    modify_transaction_window.wm_iconbitmap("finalproject/img/cash.ico")
...
def logout():
    ...
    if confirmed:
        ...
        subprocess.run(["python", r"C:\Users\admin\Desktop\finalproject\main.py"])
...
# Add a "Toggle Dark Mode" button in the sidebar
dark_mode_button = CTkButton(master=sidebar_frame, text="Toggle Dark Mode", fg_color="#fff", font=("Arial Bold", 12.75), text_color="#2A8C55", hover_color="#207244", anchor="w", command=toggle_dark_mode)
dark_mode_button.pack(anchor="center", ipady=5, pady=(150, 0))
...
mainframe = CTkFrame(app, width=620, height=645, fg_color="#B2C8BA", border_width=5, border_color="black", corner_radius=30)
mainframe.pack(fill="both", expand=True, padx=0.5, pady=0.5)



# Create a frame to hold the table
frame = CTkFrame(mainframe, width=620, height=645)
...
table.column("TransactionID", width=80)
...
table.heading("TransactionID", text="TransactionID", command=lambda: sort_by_category("TransactionID"))
...
summary_frame = CTkFrame(mainframe, width=620, height=50, fg_color="#2A8C55", corner_radius=10)
...
total_balance_label.pack(side="left", padx=15)
...
total_expenses_label.pack(side="left", padx=10)

# Define the total_savings_label and set its initial text
total_savings_label = CTkLabel(master=summary_frame, text=f"Total Savings: ₱0.00", font=("Arial Bold", 12), text_color="#fff")
total_savings_label.pack(side="left", padx=10)

################################################################

bottomframe = CTkFrame(app, width=640, height=300, fg_color="#86A789", border_width=5, border_color="black", corner_radius=30)
